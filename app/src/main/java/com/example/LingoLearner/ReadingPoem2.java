...
public class ReadingPoem2 extends AppCompatActivity {
    ...
    private int[] sounds = {R.raw.baabaablacksheep};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set text and image
        tvStoryTitle.setText(getString(R.string.title2));
        storyImage.setImageResource(R.drawable.baabaablack);
        tvStory.setText(getString(R.string.story2));
