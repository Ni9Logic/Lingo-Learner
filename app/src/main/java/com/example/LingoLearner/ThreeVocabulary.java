...
public class ThreeVocabulary extends AppCompatActivity {

    private VideoView videoView;
    private int currentVideoIndex = 0;
    private int[] videoResources = {R.raw.vocabularyclass3v1, R.raw.vocabularyclass3v2, R.raw.vocabularyclass3v3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaController mediaController = new MediaController(ThreeVocabulary.this);
