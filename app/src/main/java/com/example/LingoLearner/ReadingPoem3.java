...
public class ReadingPoem3 extends AppCompatActivity {
    ...
    private int[] sounds = {R.raw.littlemonkeys};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TrackActivities.trackActivity("Reading Poem 3 Activity");
        ...
        // Set text and image
        tvStoryTitle.setText(getString(R.string.title3));
        storyImage.setImageResource(R.drawable.littlemonkeys5);
        tvStory.setText(getString(R.string.story3));
