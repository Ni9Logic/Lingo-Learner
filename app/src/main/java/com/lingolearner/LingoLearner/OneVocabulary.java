...
public class OneVocabulary extends AppCompatActivity {

    private VideoView videoView;
    private int currentVideoIndex = 0;
    private int[] videoResources = {R.raw.vocabularyclass1v1, R.raw.vocabularyclass1v2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaController mediaController = new MediaController(OneVocabulary.this);
