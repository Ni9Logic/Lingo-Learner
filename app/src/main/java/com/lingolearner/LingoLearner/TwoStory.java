...
public class TwoStory extends AppCompatActivity {

    private VideoView videoView;
    private int currentVideoIndex = 0;
    private int[] videoResources = {R.raw.grade2v1, R.raw.grade2v2, R.raw.grade2v3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_two_story);
        ...
        MediaController mediaController = new MediaController(TwoStory.this);
